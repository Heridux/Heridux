...
class HeriduxForm extends Heridux__default['default'] {
  ...
  constructor(STATE_PROPERTY) {
    ...
    this.createAction("destroyForm", state => state.merge(immutable.fromJS(initialState)));
    this.createAction("redefineForm", (state, {
      form
    }) => state.merge(immutable.fromJS({ ...initialState,
      form
    })));
    this.createAction("setFieldValue", (state, {
      ...
      const hasChanged = !isEqual__default['default'](value, initialValue);
      let newState = state.mergeIn(key, {
        value: value && typeof value === "object" ? immutable.fromJS(value) : value,
        error: null,
        warning: null,
        touched: hasChanged
      });
    ...
    this.createAction("addFields", (state, {
      ...
      const newState = state.mergeDeepIn(["form"], immutable.fromJS(mapFields));
...
enumerable: true,
get: function () {
return formRules.FormError;
}
});
Object.defineProperty(exports, 'FormWarning', {
enumerable: true,
get: function () {
return formRules.FormWarning;
}
});

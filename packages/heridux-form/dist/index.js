...
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@heridux/form-rules'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('immutable'), require('lodash/isPlainObject'), require('lodash/isEqual'), require('@heridux/core')) :
typeof define === 'function' && define.amd ? define(['exports', '@heridux/form-rules', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/inherits', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', 'immutable', 'lodash/isPlainObject', 'lodash/isEqual', '@heridux/core'], factory) :
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.HeriduxForm = {}, global.formRules, global._typeof, global._toConsumableArray, global._defineProperty, global._classCallCheck, global._createClass, global._inherits, global._possibleConstructorReturn, global._getPrototypeOf, global.immutable, global.isPlainObject, global.isEqual, global.Heridux));
}(this, (function (exports, formRules, _typeof, _toConsumableArray, _defineProperty, _classCallCheck, _createClass, _inherits, _possibleConstructorReturn, _getPrototypeOf, immutable, isPlainObject, isEqual, Heridux) { 'use strict';

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var formRules__default = /*#__PURE__*/_interopDefaultLegacy(formRules);
...
function normalizeKey(path) {
  ...
  return Array.isArray(path) ? _toConsumableArray__default['default'](path) : path.split(".");
}
...
var HeriduxForm = /*#__PURE__*/function (_Heridux) {
  _inherits__default['default'](HeriduxForm, _Heridux);
  ...
  function HeriduxForm(STATE_PROPERTY) {
    ...
    _this.createAction("redefineForm", function (state, _ref) {
      var form = _ref.form;
      return state.merge(immutable.fromJS(_objectSpread(_objectSpread({}, initialState), {}, {
        form: form
      })));
    });
    ...
    _this.createAction("setFieldValue", function (state, _ref2) {
      var path = _ref2.path,
          value = _ref2.value;
      var key = ["form"].concat(_toConsumableArray__default['default'](path));
      ...
      var newState = state.mergeIn(key, {
        value: value && _typeof__default['default'](value) === "object" ? immutable.fromJS(value) : value,
        error: null,
        warning: null,
        touched: hasChanged
      });
    ...
    _this.createAction("initFieldValue", function (state, _ref3) {
      var path = _ref3.path,
          value = _ref3.value;
      var field = state.getIn(["form"].concat(_toConsumableArray__default['default'](path)));
      if (field.get("value") === value && field.get("initialValue") === value) return state;
      var newState = state.mergeIn(["form"].concat(_toConsumableArray__default['default'](path)), {
        initialValue: value,
        value: value,
        error: null,
        warning: null,
    ...
    _this.createAction("removeFields", function (state, _ref4) {
      var path = _ref4.path;
      return stateWithChanges(state, state.deleteIn(["form"].concat(_toConsumableArray__default['default'](path))));
    });
    ...
    _this.createAction("addFields", function (state, _ref5) {
      ...
      var newState = state.mergeDeepIn(["form"], immutable.fromJS(mapFields));
    ...
    _this.createAction("initFormValues", function (state, _ref7) {
      ...
      var newState = stateWithChanges(state, state.mergeDeepIn(["form"].concat(_toConsumableArray__default['default'](path)), emptyValues).mergeDeepIn(["form"].concat(_toConsumableArray__default['default'](path)), newValues));
    ...
    _this.createAction("resetFormValues", function (state, _ref8) {
      ...
      var newState = stateWithChanges(state, state.mergeDeepIn(["form"].concat(_toConsumableArray__default['default'](path)), newValues));
    ...
    _this.createAction("setFormValues", function (state, _ref10) {
      ...
      var newValues = _this.mapFields(function (value, key) {
        return {
          ...
          error: null,
          warning: null,
          touched: state.getIn([].concat(_toConsumableArray__default['default'](key), ["initialValue"])) !== value
        };
      }, state, values, path);

      var newState = state.mergeDeepIn(["form"].concat(_toConsumableArray__default['default'](path)), emptyValues).mergeDeepIn(["form"].concat(_toConsumableArray__default['default'](path)), newValues);
    ...
    _this.createAction("setFieldWarning", function (state, _ref11) {
      ...
      return state.mergeDeepIn(["form"].concat(_toConsumableArray__default['default'](path)), {
        warning: {
          message: message,
  ...
  _createClass__default['default'](HeriduxForm, [{
    ...
    value: function mapFields(callback, _state, _values) {
      ...
      var values = _values || state.getIn(["form"].concat(_toConsumableArray__default['default'](path)));

      if (immutable.Iterable.isIterable(values)) values = values.toJS();
      var isArray = Array.isArray(values);
      var map = isArray ? [] : {};

      var processField = function processField(value, n) {
        var newKey = [].concat(_toConsumableArray__default['default'](path), [n]);
      ...
      if (isArray) {
        ...
        throw new Error(_typeof__default['default'](values) + " : type incorrect for values iteration");
      } else {
    ...
    value: function isField(path) {
      return this.getValidationRules(path) instanceof formRules.Rules;
    }
    /**
    ...
    value: function checkFieldValue(_ref14) {
      ...
      if (!(rules instanceof formRules.Rules)) {
      ...
      try {
        ...
        if (e instanceof formRules.FormWarning) {
    ...
    value: function _getFieldProp(path, prop, state) {
      ...
      var value = store.getIn(["form"].concat(_toConsumableArray__default['default'](normalizeKey(path)), [prop]));
    ...
    value: function defineFieldRules(path, rules) {
      setKeyValue(this.validationRules, path, rules && rules instanceof formRules.Rules ? rules : new formRules.Rules());
    }
  }, {
    key: "_processForm",
    value: function _processForm(fields) {
      ...
      var processForm = function processForm(field) {
        ...
        if (isPlainObject__default['default'](field)) {
          ...
          for (var n in field) {
            hasKey = true;
            processForm(field[n], [].concat(_toConsumableArray__default['default'](key), [n]));
          }
          ...
          for (var i = 0; i < field.length; i++) {
            processForm(field[i], [].concat(_toConsumableArray__default['default'](key), [i]));
          }
        } else {
...
enumerable: true,
get: function () {
return formRules__default['default'];
}
});
...
exports.stateWithChanges = stateWithChanges;

...
var Heridux = /*#__PURE__*/function () {
  ...
  _createClass(Heridux, [{
      ...
      if (this._isReduxRegistered()) {
        return function (Component) {
          return connect(function (state, ownProps) {
            var partialState = _this2.getState(state);
    ...
    value: function createHook() {
      ...
      return function () {
        if (_this3._isReduxRegistered()) {
          useSelector(function (state) {
            return state[_this3.STATE_PROPERTY];
          });
        } else {
          var _useReducer = react.useReducer(_this3._reducer, _this3.initialState),
              _useReducer2 = _slicedToArray(_useReducer, 2),
              state = _useReducer2[0],
              dispatch = _useReducer2[1];

          _this3.dispatch = dispatch;

          _this3.getState = function () {
            return state;
          };

          _this3._hookCreated = true;
        }

        return Object.create(_this3); // new reference to force update
      };
    }
  }]);
